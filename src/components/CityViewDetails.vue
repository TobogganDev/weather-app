...
const getForecastWeather = async () => {
  try {
    const forecastData = await axios.get(`https://api.weatherapi.com/v1/forecast.json?key=47a51ac91d6f491c953222711230507&q=${route.query.location}&days=7&aqi=no&alerts=no&hour=12&lang=${browserLocales[0]}`);
